...
HOSTE = getenv("HOST_DOMAIN", default="127.0.0.1:8000")
...
DATABASES = {
    "default": {
        ...
        "PASSWORD": getenv("POSTGRES_DEFAULT_PASSWORD", default="admin1234"),
...
#Token de la Aplicación de Slack
SLACK_TOKEN = getenv("SLACK_TOKEN", default="xoxb-1969072543522-1955294602183-K7mWCDRjEEhcOvRoGRLkkd57")

#Plantilla para la notificación de menú nuevo 
TEMPLATE_NOTIFICATION = 'Se creó un menú para hoy.\n Puedes revisarlo y ordernear desde la siguiente ruta.\nhttp://'+HOSTE+'/menu/'
